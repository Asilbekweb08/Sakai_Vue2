...
function subminForm(event) {
    let form = {
        ...
        userId: userId.value,
        inputCargoName: inputCargoName.value,
        selectCargoType: selectCargoType.value,
    ...
    axios
        .post(host + '/api/create/cargo', JSON.stringify(form), { mode: 'no-cors' }, { headers })
...
const showSticky = () => {
    toast.add({ severity: 'success', summary: 'Sticky Message', detail: 'Message Content' });
};
</script>
    ...
    <Fluid>
        ...
        <div class="flex mt-8">
            <div class="card flex flex-col gap-4 w-full">
                <h1 class="text-2xl font-semibold text-zinc-950 sm:text-xl/8 dark:text-white">Создать груз</h1>
                ...
                <div class="flex flex-col gap-2">
                    <label for="inputCargoName">Наименование груза</label>
                    <InputText v-model="inputCargoName" type="text" size="large" placeholder="Какой груз вы хотите перевезти?" />
                </div>

                <div class="flex flex-col gap-2">
                    <label for="selectCargoType">Тип груза и упаковка</label>
                    <Select v-model="selectCargoType" :options="selectCargoTypes" showClear filter optionLabel="name" placeholder="Указать" class="w-full md:w-56" />
                </div>
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="flex flex-wrap gap-2 w-full">
                        ...
                        <Select v-model="selectTypeTransportation" :options="selectTypeTransportations" :filter="false" optionLabel="name" placeholder="Указать" class="w-full" />
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="flex flex-wrap gap-2 w-full">
                        ...
                        <Textarea placeholder="Что стоит учесть перевозчику?" v-model="comment" :autoResize="true" rows="3" cols="30" />
                    </div>
                </div>
